<?php
/**
 * Body partial for /replay-winning-the-ai-game/ (TLA Full HTML template).
        ...
        <div class="oh-grid">
          ...
          <div class="oh-main">
            ...
            <div class="oh-cta-foot" data-reveal="up">
              <button type="button" class="btn btn--gold btn--xl" data-ev-modal>Watch This Masterclass</button>
            </div>
