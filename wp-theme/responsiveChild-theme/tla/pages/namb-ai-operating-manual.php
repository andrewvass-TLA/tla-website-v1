        ...
        <div class="naq-hero__grid">
          ...
          <div class="naq-formcard">
            ...
            <div class="naq-formcard__embed">
              <iframe
                src="https://api.leadconnectorhq.com/widget/form/kAALoM0qH1soqgENiXFt"
                style="width:100%;height:100%;border:none;border-radius:0px"
                id="inline-kAALoM0qH1soqgENiXFt"
                ...
                data-form-name="NAMB 7.23.26"
                data-height="514"
                data-layout-iframe-id="inline-kAALoM0qH1soqgENiXFt"
                data-form-id="kAALoM0qH1soqgENiXFt"
                title="NAMB 7.23.26">
              </iframe>
            </div>
          </div>
...
<?php include get_stylesheet_directory() . '/tla/partials/footer.php'; ?>
  ...
  <!-- LeadConnector form embed (NAMB 7.23.26 form) -->
