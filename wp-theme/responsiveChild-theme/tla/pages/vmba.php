<?php
/**
 * Body partial for /vmba/ (TLA Full HTML template).
 * Generated from public/custom-sales-pages/vmba.html by scripts/convert-pages.sh — do not hand-edit;
 * edit the source HTML (or the shared header/footer partials) and re-run.
 */
if ( ! defined( 'ABSPATH' ) ) { exit; }

$tla_title       = 'VMBA Preferred Account — Exclusive Loan Atlas Pricing';
$tla_description = 'VMBA member pricing: full access to The Loan Atlas at $149/mo — down from $349/mo — locked in, plus 3 months free of Platinum Marketing.';
$tla_active      = '';
?>
  <style>
    ...
    /* Savings line directly above the hero CTA — bold italic green. */
    .vmba-hero-save {
      font-family: var(--font-body);
      font-weight: 800;
      font-style: italic;
    ...
    /* Co-branded logo lockup — Loan Atlas | VMBA (styled to match the nav lockup:
       gold logo, thin vertical divider, VMBA logo bare in brand blue). */
    .mm-plan__lockup {
      display: flex;
      align-items: center;
      justify-content: center;
    ...
    /* Gold Loan Atlas logo — matched to the VMBA logo's image height. */
    ...
    <section class="lp-intro" aria-labelledby="mm-hero-heading">
      <div class="container">
        <div class="lp-intro__content">
          ...
          <p class="vmba-hero-save" data-hero-step="1">Save $2,700 as a VMBA Member!</p>
          <div class="lp-intro__actions" data-hero-step="4">
            <a class="btn btn--gold btn--lg" href="https://members.theloanatlas.com/checkouts/premium-membership-checkout-namb/">Activate Your VMBA Preferred Account</a>
          </div>
        </div>
      </div>
    ...
    <section class="mm-offer" aria-labelledby="mm-offer-heading">
      <div class="container">
        <div id="vmba-form" class="mm-offer__card" data-reveal="scale">
          <div class="mm-plan__lockup" aria-label="The Loan Atlas — VMBA Preferred Account pricing">
            ...
            <img class="mm-plan__lockup-mm" src="<?php echo TLA_BASE; ?>/assets/vmba-logo.jpg" alt="VMBA" />
          </div>
          ...
          <p class="mm-plan__save"><span class="mm-plan__save-pill"><em>$2,700</em> in Annual Savings — Exclusively for VMBA Members</span></p>
        ...
        <div class="lp-bridge__stack">
          ...
          <div class="lp-bridge__inner" data-reveal="up">
            ...
            <p class="text-brass" style="font-family: var(--font-display); font-size: clamp(1.5rem, 1.1rem + 1.4vw, 2.125rem); font-weight: 800; line-height: 1.25; letter-spacing: -0.015em; margin: 0;">
              With your VMBA Preferred Pricing, you can install them all for less than the commission of one extra loan.
            </p>
          </div>
    ...
    <section class="mm-pricing" id="pricing" aria-labelledby="pricing-heading">
      <div class="container">
        <div class="center" data-reveal="up" style="max-width: 46rem; margin-inline: auto;">
          ...
          <p class="t-body-lg" style="color: rgba(255, 255, 255, 0.68); font-size: clamp(1.125rem, 0.95rem + 0.6vw, 1.375rem);">Full access to everything above — the AI systems, live coaching, the curriculum, the community — at exclusive VMBA Preferred Account pricing.</p>
        </div>
        ...
        <article id="vmba-pricing-card" class="mm-plan" data-reveal="scale">
          ...
          <div class="mm-plan__cta">
            <a class="btn btn--gold btn--lg" href="https://members.theloanatlas.com/checkouts/premium-membership-checkout-namb/">
              Activate Your VMBA Preferred Account
            </a>
          </div>
          ...
          <ul class="mm-plan__list">
            ...
            <li>
              <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>
              Platinum Marketing free for 3 months (then $69/mo, or cancel)
            </li>
            <li>
              <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>
