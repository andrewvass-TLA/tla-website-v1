<?php
/**
 * Body partial for /namb-build-your-custom-gpt/ (TLA Full HTML template).
 * Generated from public/namb-build-your-custom-gpt.html by scripts/convert-pages.sh — do not hand-edit;
 * edit the source HTML (or the shared header/footer partials) and re-run.
 */
if ( ! defined( 'ABSPATH' ) ) { exit; }

$tla_title       = 'Build Your Custom GPT — The Loan Atlas';
$tla_description = 'Build your own custom GPT trained on your business — who you serve, how you solve problems, and how you sound — so it writes like you every single time.';
$tla_active      = '';
?>
  <style>
    /* Blur-up swatch while the Wistia web component defines itself */
    wistia-player[media-id='xt5qor0svt']:not(:defined) {
      background: center / contain no-repeat url('https://fast.wistia.com/embed/medias/xt5qor0svt/swatch');
      display: block;
      filter: blur(5px);
      padding-top: 56.25%;
    }
    ...
    @media (max-width: 767.98px) {
      ...
      /* chrome.css already gives `body > main` a 72px top pad to clear the fixed
         header. The savings band is fixed just below that header and is ~53px
         tall (its copy wraps to two lines on narrow screens, more on the
         narrowest), so the hero must add at least the band height + spacing on
         top. Use a generous floor so the eyebrow always clears the band.
         Doubled class raises specificity so this wins over the base .naq-hero
         padding-top regardless of source order. */
      .naq-hero.naq-hero {
        padding-top: calc(64px + clamp(24px, 6vw, 40px));
      }
    ...
    @media (min-width: 900px) {
      ...
      /* Margins are handled by the flex gap above at this breakpoint. */
      .naq-hero__copy > .naq-hero__title,
      .naq-hero__copy > .naq-hero__sub {
        margin-bottom: 0;
      }
    }
    ...
    .naq-wins__check svg { width: 14px; height: 14px; display: block; }
    ...
    /* form_embed.js resizes the iframe to the form's own height (~514px);
  ...
  <main class="naq">
      ...
      <div class="container">
        <div class="naq-hero__grid">
          ...
          <div class="naq-hero__copy">
            <h1 id="naq-title" class="naq-hero__title">Build Your Custom GPT: Step-By-Step</h1>
            <p class="naq-hero__sub">Download this guide and get everything you need to build a powerful AI assistant the right way in just a few minutes.</p>
            <ul class="naq-wins">
              <li class="naq-wins__item">
                ...
                <span>The <strong>copy-paste master prompt</strong> that makes ChatGPT ask you the right questions, then write the instructions for you</span>
              </li>
              <li class="naq-wins__item">
                <span class="naq-wins__check" aria-hidden="true"><svg viewBox="0 0 20 20" fill="none"><path d="M4 10.5l4 4 8-9" stroke="#021c36" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/></svg></span>
                <span>Steps for <strong>building your assistant by voice</strong>, so you can describe what you need out loud and let ChatGPT do the heavy lifting</span>
              </li>
              <li class="naq-wins__item">
                <span class="naq-wins__check" aria-hidden="true"><svg viewBox="0 0 20 20" fill="none"><path d="M4 10.5l4 4 8-9" stroke="#021c36" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/></svg></span>
                <span>The <strong>complete build checklist</strong> to make sure your GPT is functional and shareable</span>
              </li>
            </ul>
          </div>
          ...
          <div class="naq-formcard">
            <div class="naq-formcard__head">
              <h2 class="naq-formcard__title">Start Building Your Custom GPT</h2>
              <p class="naq-formcard__sub">Enter your info and we&rsquo;ll send you the full guide.</p>
            </div>
            <div class="naq-formcard__embed">
              <iframe
                src="https://api.leadconnectorhq.com/widget/form/g8rOF4uK6UCjofD1Q0FF"
                style="width:100%;height:100%;border:none;border-radius:0px"
                id="inline-g8rOF4uK6UCjofD1Q0FF"
                ...
                data-form-name="NAMB 8.18.26"
                data-height="514"
                data-layout-iframe-id="inline-g8rOF4uK6UCjofD1Q0FF"
                data-form-id="g8rOF4uK6UCjofD1Q0FF"
                title="NAMB 8.18.26">
              </iframe>
            </div>
          </div>
    ...
    <!-- ── REPLAY — previous session video ──────────────────────────────────── -->
    <section class="naq-replay" aria-labelledby="naq-replay-title">
      <div class="container">
        <div class="naq-replay__head">
          <span class="naq-replay__eyebrow">Missed our last webinar?</span>
          <h2 id="naq-replay-title" class="naq-replay__title">Win More, Work Less: How Top-Producing Loan Officers are Using AI to Future-Proof Their Income</h2>
          <p class="naq-replay__sub">Watch the full recording of our previous session and start building your <a class="naq-replay__link" href="https://www.theloanatlas.com/namb-ai-operating-manual/">Mortgage Advisor AI Operating Manual</a>.</p>
        </div>
        <div class="naq-replay__frame">
          <!-- Wistia loader scripts live in <body> (the build strips <head> scripts) -->
          <script src="https://fast.wistia.com/player.js" async></script>
          <script src="https://fast.wistia.com/embed/xt5qor0svt.js" async type="module"></script>
          <wistia-player media-id="xt5qor0svt" seo="false" aspect="1.7777777777777777"></wistia-player>
        </div>
      </div>
    </section>
...
<?php include get_stylesheet_directory() . '/tla/partials/footer.php'; ?>
  ...
  <!-- LeadConnector form embed (NAMB 8.18.26 form) -->
