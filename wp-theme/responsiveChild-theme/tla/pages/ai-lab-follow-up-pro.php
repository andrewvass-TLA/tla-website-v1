<?php
/**
 * Body partial for /ai-lab-follow-up-pro/ (TLA Full HTML template).
 * Generated from public/replay-ai-lab-follow-up-pro.html by scripts/convert-pages.sh — do not hand-edit;
 * edit the source HTML (or the shared header/footer partials) and re-run.
 */
if ( ! defined( 'ABSPATH' ) ) { exit; }

$tla_title       = 'AI Lab: Follow Up Pro — Replay — The Loan Atlas';
$tla_description = 'Watch the replay of AI Lab: Follow Up Pro — analyze, organize, and execute on every conversation in 90 seconds: organized notes, a CRM-ready summary, a tailored follow-up email and a proactive agent update, all written in your voice.';
$tla_active      = '';
?>
  <style>
        ...
        <div class="oh-grid">
          ...
          <div class="oh-main">
            ...
            <div class="oh-header" data-reveal="up">
              <div class="oh-thumb">
                <img src="<?php echo TLA_BASE; ?>/assets/live-events/past-events/AI-Lab-Follow-Up-Pro-0514-16x9.jpg" alt="AI Lab: Follow Up Pro — The Loan Atlas" loading="eager" />
              </div>
              <div class="oh-meta">
            ...
            <section data-reveal="up">
              <p class="oh-prose">Every loan originator knows the feeling: you hang up from a great client call, get pulled into the next fire, and realize hours later that the one detail that mattered never made it into your notes. By the time the file reaches operations, the story's incomplete — and it costs you.</p>
              <p class="oh-prose">In this AI Lab, you'll be introduced to Follow Up Pro, the Loan Atlas GPT built to close that gap. Josh Mettle walks through exactly how top producers turn a single recorded call into a clean operations handoff, a client follow-up, and a realtor update in minutes. You'll see the tool run live on a real, complex self-employed borrower scenario, learn how to capture the calls that feed it, and understand where Follow Up Pro fits in the broader AI maturity ladder — from assistant to full operational system.</p>
              <p class="oh-prose">Whether you're brand new or decades into the business, this session is about building a consistent, professional communication system that protects your files and your reputation.</p>
            </section>
            ...
            <section data-reveal="up">
              ...
              <ul class="oh-list">
                <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg><span>How inconsistent post-call communication quietly blows up loans — and how Follow Up Pro solves it</span></li>
                <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg><span>How to run the tool on a complex, self-employed borrower "dreams and goals" call, start to finish</span></li>
                <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg><span>What Follow Up Pro produces for you: an operations summary, an LO strategy note, a client text, a client email, and a realtor update</span></li>
                <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg><span>How to capture the calls that feed the tool (Plaud, iPhone recording, Zoom transcripts) — plus the simple permission script that gets a yes every time</span></li>
                <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg><span>How to review, edit, and override the tool's strategy suggestions instead of blindly copy-pasting</span></li>
                <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg><span>How the built-in compliance guardrails keep non-public borrower information out of client and realtor messages</span></li>
                <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg><span>When to use Follow Up Pro versus the Sales &amp; Scripting Coach — and why each GPT has to stay in its own lane</span></li>
                <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg><span>How to build the recording habit and get past the discomfort of hitting record on a client call</span></li>
              </ul>
            </section>

            <!-- Pull-quote — shared testimonial block (no gold mark; inline quotes instead) -->
            <figure class="quote-card" data-reveal="up">
              <blockquote class="quote-card__quote">&ldquo;You can measure that this tool saves you thirty minutes upfront, but you can&rsquo;t measure what it saves you from files not blowing up, and you can&rsquo;t measure the reputational difference. We get reputations as originators &mdash; and that&rsquo;s a return on investment we can&rsquo;t measure, but we know it&rsquo;s true.&rdquo;</blockquote>
          ...
          <aside class="oh-side" data-reveal="up">
            ...
            <div class="oh-side__head">
              <h2 class="oh-side__title">Get On-Demand Access to Every AI Lab</h2>
            ...
            <div class="tlc-navy">
              <div class="tlc-navy__in">
                ...
                <p class="tlc-navy__text">Every AI Lab replay is included with membership. Here's everything you unlock inside The Loan Atlas:</p>
            ...
            <div class="tlc-split">
              ...
              <div class="tlc-split__body" style="padding-bottom:0;">
                ...
                <iframe src="https://api.leadconnectorhq.com/widget/booking/5MfGSBd2cfTjpKzdFXGi"
                  ...
                  id="oh-booking-replay-follow-up-pro" data-embed-id="oh-booking-replay-follow-up-pro" title="Schedule Booking"></iframe>
              </div>
            </div>
