...
$tla_title       = 'Leveraging Google Reviews to Attract Clients and Agents — Replay — The Loan Atlas';
$tla_description = 'Watch the replay of Leveraging Google Reviews to Attract Clients and Agents — Tyler Osby and Giuseppe Battaglioli on how to ask for reviews naturally, earn the intentional ones that pre-answer a client’s doubts, and put reviews to work at every stage of your business.';
$tla_active      = '';
?>
  <style>
        ...
        <div class="oh-grid">
          ...
          <div class="oh-main">
            ...
            <div class="oh-header" data-reveal="up">
              <div class="oh-thumb">
                <img src="<?php echo TLA_BASE; ?>/assets/live-events/past-events/Masterclass-Leveraging-Google-Reviews-0903-16x9.png" alt="Leveraging Google Reviews to Attract Clients and Agents — The Loan Atlas" loading="eager" />
              </div>
            ...
            <section data-reveal="up">
              <p class="oh-prose">Long before a client or a referral partner ever reaches out to you, they&rsquo;ve already looked you up and started deciding whether you&rsquo;re worth trusting. Your reviews are doing that talking whether you&rsquo;re paying attention to them or not, and in today&rsquo;s market they may be the most powerful form of social proof you have.</p>
              <p class="oh-prose">In this masterclass, Loan Atlas faculty member Tyler Osby and longtime originator Giuseppe Battaglioli show you how to make reviews work for you on purpose. Between them they&rsquo;ve earned thousands of five-star reviews (Tyler alone is past 1,472 on Google), and this goes well beyond simply collecting them. They break down how to ask for reviews naturally, how to earn the specific ones that answer a client&rsquo;s doubts before those doubts are ever spoken, and how to weave reviews through every stage of your business so they keep generating trust, clients, and agent relationships long after a loan closes.</p>
            </section>
            ...
            <section data-reveal="up">
              ...
              <ul class="oh-list">
                <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg><span>Why Google reviews drive real inbound business when other review platforms often don&rsquo;t</span></li>
                <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg><span>How to claim and own your personal Google Business profile, so your reviews follow you instead of staying with your branch</span></li>
                <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg><span>How to ask for reviews naturally at the right moments in the loan process, without it ever feeling awkward</span></li>
                <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg><span>How to earn intentional reviews tied to specific wins (fast closings, matching builder-preferred lenders, zero-down options) so each one pre-answers the next client&rsquo;s objection</span></li>
                <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg><span>Where to put reviews to work: pre-approval and lender letters, your email signature, your website, social media, and referral-partner communication</span></li>
                <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg><span>How to reply to every review, repurpose them into content, and turn even a negative review into proof that you make things right</span></li>
              </ul>
            </section>

            <!-- Pull-quote — shared testimonial block (no gold mark; inline quotes instead) -->
            <figure class="quote-card" data-reveal="up">
              <blockquote class="quote-card__quote">&ldquo;Reviews are silent salespeople. People are looking into you before they ever talk to you, to figure out who you are and whether you&rsquo;re going to be good at what they&rsquo;re hiring you to do.&rdquo;</blockquote>
              <figcaption class="quote-card__attr">
                <div class="quote-card__name">Tyler Osby</div>
              </figcaption>
            </figure>
