...
?>
  <style>
    ...
    /* The LeadConnector iframe reports its own height (data-height=754); give it a
       floor so it renders before the embed script resizes it. */
    ...
    <section class="mm-offer" aria-labelledby="mm-offer-heading">
      <div class="container">
        <div id="acm-form" class="mm-offer__card" data-reveal="scale">
          ...
          <h3 class="mm-plan__hero-title mm-offer__hero-title" style="color: #ffffff;">Preferred Account Pricing</h3>
          ...
          <div id="mm-offer-heading" class="mm-offer__steps" style="grid-template-columns: 1fr; max-width: 22rem;">
            <div class="mm-step mm-step--rest">
              ...
              <span class="mm-step__price">$199<span style="font-size: 0.32em; font-weight: 700; letter-spacing: 0;">/mo</span></span>
            </div>
          </div>
