<?php
/**
 * Body partial for /office-hours-marc-bui/ (TLA Full HTML template).
 * Generated from public/office-hours-marc-bui.html by scripts/convert-pages.sh — do not hand-edit;
 * edit the source HTML (or the shared header/footer partials) and re-run.
 */
if ( ! defined( 'ABSPATH' ) ) { exit; }

$tla_title       = 'Office Hours with Marc Bui — The Loan Atlas';
$tla_description = 'Join Marc Bui\'s live office hours inside The Loan Atlas — bring your live deals and get real-time answers from a top-producing coach.';
$tla_active      = '';
?>
  <style>
    ...
    /* Marc's faculty video — 16:9 embed */
    .oh-video {
    ...
    /* ================================================================
       ...
       opened by either "Join Marc's Office Hours" CTA.
       ================================================================ */
    .ev-modal {
        ...
        <div class="oh-grid">
          ...
          <div class="oh-main">
            ...
            <div class="oh-header" data-reveal="up">
              <div class="oh-thumb">
                <img src="<?php echo TLA_BASE; ?>/assets/live-events/Office-Hours-Marc-Bui.png" alt="Office Hours with Marc Bui" loading="eager" />
              </div>
              ...
              <h1 class="oh-title">Office Hours with Marc Bui</h1>
              </div>
            </div>
            ...
            <!-- Marc's faculty video -->
            <section data-reveal="up">
              <div class="oh-video">
                <iframe src="https://www.youtube-nocookie.com/embed/CsdqQu0XHaA"
                  title="Marc Bui — Faculty introduction"
            ...
            <!-- About Marc -->
            <section data-reveal="up">
              <h2 class="oh-h2">About Marc Bui</h2>
              <div class="oh-about">
                <div class="oh-about__photo">
                  <img src="<?php echo TLA_BASE; ?>/assets/marc-bui-headshot.png" alt="Marc Bui" loading="lazy" />
                </div>
                <div class="oh-about__body">
                  <p>Marc has personally originated $750M while building a 75,000+ Instagram audience that generates real loan volume. He&rsquo;s one of the few originators who has cracked social media as a primary lead source instead of a vanity channel.</p>
                  <p>As Branch Manager at Thrive Lending Group, his specialty is social media marketing with deep authority on Instagram specifically — the difference between content that builds an audience and content that builds a pipeline, and how to do the latter while running a real origination business.</p>
                </div>
              </div>
            </section>
            ...
            <!-- Specialties -->
            <section data-reveal="up">
              <h2 class="oh-h2">Marc's Specialties</h2>
              <div class="oh-chips">
                <span class="oh-chip">Social Media Marketing</span>
                <span class="oh-chip">Instagram Authority</span>
                <span class="oh-chip">Content That Builds Pipeline</span>
                <span class="oh-chip">Audience-Building</span>
                <span class="oh-chip">Lead Generation</span>
              </div>
            </section>

            <!-- 2025 Production -->
            <section data-reveal="up">
              <h2 class="oh-h2">Marc's 2025 Production</h2>
              <div class="oh-stats oh-stats--2">
                <div class="oh-stat">
                  <div class="oh-stat__num" data-countup="45.9" data-countup-prefix="$" data-countup-suffix="M">$45.9M</div>
                  <div class="oh-stat__label">Total funded volume</div>
                </div>
                <div class="oh-stat">
                  <div class="oh-stat__num" data-countup="70" data-countup-suffix="">70</div>
            ...
            <div class="oh-cta-foot" data-reveal="up">
              <button type="button" class="tlc-btn oh-join-btn" data-ev-modal>Join Marc's Office Hours</button>
            </div>
          ...
          <aside class="oh-side" data-reveal="up">
            ...
            <div class="oh-side__head">
              <h2 class="oh-side__title">Want to Be Coached By Marc?</h2>
            ...
            <div class="tlc-split">
              ...
              <div class="tlc-split__body" style="padding-bottom:0;">
                ...
                <iframe src="https://api.leadconnectorhq.com/widget/booking/5MfGSBd2cfTjpKzdFXGi"
                  ...
                  id="oh-booking-bui" data-embed-id="oh-booking-bui" title="Schedule Booking"></iframe>
              </div>
            </div>
      ...
      <div class="ev-modal__head">
        ...
        <div class="ev-modal__strip" aria-hidden="true">
          <div class="ev-modal__strip-row">
            ...
            <img src="<?php echo TLA_BASE; ?>/assets/live-events/Office-Hours-Marc-Bui-Square.png" alt="" loading="lazy" />
