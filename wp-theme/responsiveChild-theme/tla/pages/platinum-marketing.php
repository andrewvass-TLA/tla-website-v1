...
?>
  <style>
    ...
    .mm-stack--single { grid-template-columns: 1fr; justify-items: center; }
    /* Newsletter — single portrait image, kept no taller than the social 2×2 grid */
    .mm-stack--single .mm-stack__img { max-width: 62%; }
    /* Landing Pages — both forced to the shorter (right) image's height; left one crops */
    .mm-stack--landing { align-items: start; }
    .mm-stack--landing .mm-stack__img--crop { height: 100%; object-fit: cover; object-position: top; }
    .mm-stack--landing .mm-stack__img--ref { align-self: start; }
      ...
      <div class="pl-hero-assistant" data-hero-step="5">
        ...
        <div class="pl-hero-marquee" aria-hidden="true">
          <div class="pl-hero-marquee__track">
            ...
            <div class="pl-hero-marquee__item"><img src="<?php echo TLA_BASE; ?>/assets/platinum-newsletter.png" alt="" loading="lazy" /></div>
            ...
            <div class="pl-hero-marquee__item"><img src="<?php echo TLA_BASE; ?>/assets/platinum-landing-page-2.png" alt="" loading="lazy" /></div>
            ...
            <div class="pl-hero-marquee__item"><img src="<?php echo TLA_BASE; ?>/assets/platinum-social-image-4.png" alt="" loading="lazy" /></div>
      ...
      <div class="container">
        <div class="grid-2" style="gap: var(--space-xl); align-items: center;">
          <div class="grid" style="grid-template-columns: 1fr;" data-reveal="left">
            ...
            <p class="t-body-lg t-muted" style="margin-bottom: var(--space-md);">Your clients and partners are being bombarded with marketing messages all day, every day — and their brains have built a filter against most of it.</p>
            <p class="t-body-lg t-muted" style="margin: 0;">Most mortgage marketing hits that filter and bounces: emails deleted on subject line alone, flyers tossed without a glance, social posts scrolled past in half a second.</p>
          </div>
        ...
        <p data-reveal="up" style="margin: clamp(40px, 5vw, 64px) auto 0; max-width: 68rem; text-align: center; font-family: var(--font-display); font-size: clamp(1.375rem, 1.1rem + 1.1vw, 1.875rem); font-weight: 700; line-height: 1.3; letter-spacing: -0.01em; color: var(--on-surface);">The marketing that breaks through the noise is built on a specific set of principles most loan officers have never been taught.</p>

        <div class="compare-v2 compare-v2--wide" style="margin-top: var(--space-lg);" data-reveal="up">
    ...
    <section class="mm-tour" id="inside" aria-labelledby="inside-heading">
      <div class="container">
        ...
        <div class="mm-tour__rows">
          ...
          <div class="mm-row" data-reveal="up">
            <div class="mm-stack mm-stack--single" aria-hidden="true">
              <img class="mm-stack__img" src="<?php echo TLA_BASE; ?>/assets/platinum-newsletter.png" alt="" loading="lazy" />
            </div>
            <div class="mm-row__copy">
          ...
          <div class="mm-row mm-row--flip" data-reveal="up">
            <div class="mm-stack" aria-hidden="true">
              ...
              <img class="mm-stack__img" src="<?php echo TLA_BASE; ?>/assets/platinum-social-image-4.png" alt="" loading="lazy" />
            </div>
            <div class="mm-row__copy">
          ...
          <div class="mm-row" data-reveal="up">
            <div class="mm-stack mm-stack--landing" aria-hidden="true">
              <img class="mm-stack__img mm-stack__img--crop" src="<?php echo TLA_BASE; ?>/assets/platinum-landing-page-1.png" alt="" loading="lazy" />
              <img class="mm-stack__img mm-stack__img--ref" src="<?php echo TLA_BASE; ?>/assets/platinum-landing-page-2.png" alt="" loading="lazy" />
            </div>
            <div class="mm-row__copy">
