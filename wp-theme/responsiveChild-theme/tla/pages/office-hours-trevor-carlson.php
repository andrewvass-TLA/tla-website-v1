<?php
/**
 * Body partial for /office-hours-trevor-carlson/ (TLA Full HTML template).
 * Generated from public/office-hours-trevor-carlson.html by scripts/convert-pages.sh — do not hand-edit;
 * edit the source HTML (or the shared header/footer partials) and re-run.
 */
if ( ! defined( 'ABSPATH' ) ) { exit; }

$tla_title       = 'Office Hours with Trevor Carlson — The Loan Atlas';
$tla_description = 'Join Trevor Carlson\'s live office hours inside The Loan Atlas — bring your live deals and get real-time answers from a top-producing coach.';
$tla_active      = '';
?>
  <style>
    ...
    /* Trevor's faculty video — 16:9 embed */
    .oh-video {
    ...
    /* ================================================================
       ...
       opened by either "Join Trevor's Office Hours" CTA.
       ================================================================ */
    .ev-modal {
        ...
        <div class="oh-grid">
          ...
          <div class="oh-main">
            ...
            <div class="oh-header" data-reveal="up">
              <div class="oh-thumb">
                <img src="<?php echo TLA_BASE; ?>/assets/live-events/Office-Hours-Trevor-Carlson-0805-16x9.jpg" alt="Office Hours with Trevor Carlson" loading="eager" />
              </div>
              ...
              <h1 class="oh-title">Office Hours with Trevor Carlson</h1>
              </div>
            </div>
            ...
            <!-- Trevor's faculty video -->
            <section data-reveal="up">
              <div class="oh-video">
                <iframe src="https://www.youtube-nocookie.com/embed/F48bmBMJDiI"
                  title="Trevor Carlson — Faculty introduction"
            ...
            <!-- About Trevor -->
            <section data-reveal="up">
              <h2 class="oh-h2">About Trevor Carlson</h2>
              <div class="oh-about">
                <div class="oh-about__photo">
                  <img src="<?php echo TLA_BASE; ?>/assets/trevor-carlson-headshot.png" alt="Trevor Carlson" loading="lazy" />
                </div>
                <div class="oh-about__body">
                  <p>Trevor has helped more than 1,700 families across $400M+ in lifetime production, with deep expertise in the reverse mortgage market most originators never touch. He runs his business through a tightly engineered consumer-direct system.</p>
                  <p>His specialty is reverse mortgage, plus consumer-direct marketing and operational systems — adding reverse as a complementary product line to a traditional mortgage business, and running a high-volume direct-to-consumer model with discipline.</p>
                </div>
              </div>
            </section>
            ...
            <!-- Specialties -->
            <section data-reveal="up">
              <h2 class="oh-h2">Trevor's Specialties</h2>
              <div class="oh-chips">
                <span class="oh-chip">Reverse Mortgage</span>
                <span class="oh-chip">Consumer-Direct Marketing</span>
                <span class="oh-chip">Operational Systems</span>
                <span class="oh-chip">High-Volume Origination</span>
              </div>
            </section>

            <!-- 2025 Production -->
            <section data-reveal="up">
              <h2 class="oh-h2">Trevor's 2025 Production</h2>
              <div class="oh-stats oh-stats--2">
                <div class="oh-stat">
                  <div class="oh-stat__num" data-countup="21" data-countup-prefix="$" data-countup-suffix="M">$21M</div>
                  <div class="oh-stat__label">Total funded volume</div>
                </div>
                <div class="oh-stat">
                  <div class="oh-stat__num" data-countup="69" data-countup-suffix="">69</div>
            ...
            <div class="oh-cta-foot" data-reveal="up">
              <button type="button" class="tlc-btn oh-join-btn" data-ev-modal>Join Trevor's Office Hours</button>
            </div>
          ...
          <aside class="oh-side" data-reveal="up">
            ...
            <div class="oh-side__head">
              <h2 class="oh-side__title">Want to Be Coached By Trevor?</h2>
            ...
            <div class="tlc-split">
              ...
              <div class="tlc-split__body" style="padding-bottom:0;">
                ...
                <iframe src="https://api.leadconnectorhq.com/widget/booking/5MfGSBd2cfTjpKzdFXGi"
                  ...
                  id="oh-booking-trevor" data-embed-id="oh-booking-trevor" title="Schedule Booking"></iframe>
              </div>
            </div>
      ...
      <div class="ev-modal__head">
        ...
        <div class="ev-modal__strip" aria-hidden="true">
          <div class="ev-modal__strip-row">
            ...
            <img src="<?php echo TLA_BASE; ?>/assets/live-events/Office-Hours-Trevor-Carlson-0805.png" alt="" loading="lazy" />
