    ...
    <section class="ev-section">
      <div class="container">
        ...
        <div class="ev-grid" data-reveal-stagger="80">
          ...
          <article class="ev-card">
            <a class="ev-card__media" href="/market-update-with-barry-habib/" tabindex="-1" aria-hidden="true"><img src="<?php echo TLA_BASE; ?>/assets/live-events/Market-Update-Barry-Habib-0820-1x1.jpg" alt="Masterclass with Barry Habib" loading="lazy" /></a>
            <div class="ev-card__body">
              <div class="ev-card__date">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
                Aug 20, 2026 · 11:00 AM PT
              </div>
              <h3 class="ev-card__title">Masterclass with Barry Habib</h3>
