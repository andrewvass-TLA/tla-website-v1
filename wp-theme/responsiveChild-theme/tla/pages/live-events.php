...
?>
  <style>
    ...
    .ev-tag--on-dark.ev-tag--talk-to-tim { background: rgba(234, 194, 90, 0.16); color: var(--brass-bright); border-color: rgba(234, 194, 90, 0.35); }
        ...
        <div class="ev-library" data-reveal-stagger="90">
          ...
          <a class="ev-pastcard" href="/leveraging-google-reviews-to-attract-clients-and-agents/">
            <div class="ev-pastcard__media">
              <img src="<?php echo TLA_BASE; ?>/assets/live-events/past-events/Masterclass-Leveraging-Google-Reviews-0903-16x9.png" alt="" loading="lazy" />
            </div>
            <div class="ev-pastcard__body">
              <span class="ev-pastcard__recorded">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
                Recorded on Sep 3, 2026
              </span>
              <h3 class="ev-pastcard__title">Leveraging Google Reviews to Attract Clients and Agents</h3>
              <p class="ev-pastcard__desc">Tyler Osby and Giuseppe Battaglioli broke down how to make reviews work for you on purpose &mdash; how to ask naturally at the right moments, how to earn the intentional reviews that pre-answer a client&rsquo;s objection before it&rsquo;s spoken, and where to put them to work so they keep generating trust and referrals long after a loan closes.</p>
