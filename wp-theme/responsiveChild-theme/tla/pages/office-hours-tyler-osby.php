<?php
/**
 * Body partial for /office-hours-tyler-osby/ (TLA Full HTML template).
 * Generated from public/office-hours-tyler-osby.html by scripts/convert-pages.sh — do not hand-edit;
 * edit the source HTML (or the shared header/footer partials) and re-run.
 */
if ( ! defined( 'ABSPATH' ) ) { exit; }

$tla_title       = 'Office Hours with Tyler Osby — The Loan Atlas';
$tla_description = 'Join Tyler Osby\'s live office hours inside The Loan Atlas — bring your live deals and get real-time answers from a top-producing coach.';
$tla_active      = '';
?>
  <style>
    ...
    /* Tyler's faculty video — 16:9 embed */
    .oh-video {
    ...
    /* ================================================================
       ...
       opened by either "Join Tyler's Office Hours" CTA.
       ================================================================ */
    .ev-modal {
        ...
        <div class="oh-grid">
          ...
          <div class="oh-main">
            ...
            <div class="oh-header" data-reveal="up">
              <div class="oh-thumb">
                <img src="<?php echo TLA_BASE; ?>/assets/live-events/Office-Hours-Tyler-Osby-0826-16x9.jpg" alt="Office Hours with Tyler Osby" loading="eager" />
              </div>
              <div class="oh-meta">
              ...
              <h1 class="oh-title">Office Hours with Tyler Osby</h1>
            </div>
            ...
            <!-- Tyler's faculty video -->
            <section data-reveal="up">
              <div class="oh-video">
                <iframe src="https://www.youtube-nocookie.com/embed/wiDWdTX1n3Y"
                  title="Tyler Osby — Faculty introduction"
            ...
            <!-- About Tyler -->
            <section data-reveal="up">
              <h2 class="oh-h2">About Tyler Osby</h2>
              <div class="oh-about">
                <div class="oh-about__photo">
                  <img src="<?php echo TLA_BASE; ?>/assets/tyler-osby-headshot.png" alt="Tyler Osby" loading="lazy" />
                </div>
                <div class="oh-about__body">
                  <p>Tyler has personally helped more than 1,962 families across $422M in lifetime production, all while building a parallel reputation as one of the most systems-minded originators in the country. Through Osby Labs, he develops the technology stacks and automated workflows that top originators actually use.</p>
                  <p>His specialty is systems, technology, and scripting — turning the day-to-day execution of calls, follow-ups, and workflows into something that runs without an originator having to remember every step.</p>
                </div>
              </div>
            </section>
            ...
            <!-- Specialties -->
            <section data-reveal="up">
              <h2 class="oh-h2">Tyler's Specialties</h2>
              <div class="oh-chips">
                <span class="oh-chip">Systems &amp; Workflows</span>
                <span class="oh-chip">Technology Stacks</span>
                <span class="oh-chip">Scripting</span>
                <span class="oh-chip">Automated Follow-Up</span>
                <span class="oh-chip">Business Development</span>
              </div>
            </section>

            <!-- 2025 Production -->
            <section data-reveal="up">
              <h2 class="oh-h2">Tyler's 2025 Production</h2>
              <div class="oh-stats oh-stats--2">
                <div class="oh-stat">
                  <div class="oh-stat__num" data-countup="60.9" data-countup-prefix="$" data-countup-suffix="M">$60.9M</div>
                  <div class="oh-stat__label">Total funded volume</div>
                </div>
                <div class="oh-stat">
                  <div class="oh-stat__num" data-countup="210" data-countup-suffix="">210</div>
            ...
            <div class="oh-cta-foot" data-reveal="up">
              <button type="button" class="tlc-btn oh-join-btn" data-ev-modal>Join Tyler's Office Hours</button>
            </div>
          ...
          <aside class="oh-side" data-reveal="up">
            ...
            <div class="oh-side__head">
              <h2 class="oh-side__title">Want to Be Coached By Tyler?</h2>
            ...
            <div class="tlc-split">
              ...
              <div class="tlc-split__body" style="padding-bottom:0;">
                ...
                <iframe src="https://api.leadconnectorhq.com/widget/booking/5MfGSBd2cfTjpKzdFXGi"
                  ...
                  id="oh-booking-osby" data-embed-id="oh-booking-osby" title="Schedule Booking"></iframe>
              </div>
            </div>
