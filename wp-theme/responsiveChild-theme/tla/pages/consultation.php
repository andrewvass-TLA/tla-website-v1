      ...
      <div class="container">
        <div class="hero-booking">
          ...
          <div class="hero-v2__intro">
            ...
            <p class="t-body-lg" data-hero-step="3">You can't fix what you can't see. This free 1-hour business assessment will show you exactly where
          ...
          <div data-hero-step="5">
            <div class="booking-card">
              ...
              <iframe src="https://api.leadconnectorhq.com/widget/booking/5MfGSBd2cfTjpKzdFXGi"
                class="booking-card__iframe" allow="payment" scrolling="no"
                id="BOsyPdKSxuiFky6PDbge_1785787148144"
                data-embed-id="BOsyPdKSxuiFky6PDbge_1785787148144" title="Schedule Booking"></iframe>
            </div>
          </div>
