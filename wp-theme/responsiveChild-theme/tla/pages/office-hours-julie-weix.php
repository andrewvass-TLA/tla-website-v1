<?php
/**
 * Body partial for /office-hours-julie-weix/ (TLA Full HTML template).
 * Generated from public/office-hours-julie-weix.html by scripts/convert-pages.sh — do not hand-edit;
 * edit the source HTML (or the shared header/footer partials) and re-run.
 */
if ( ! defined( 'ABSPATH' ) ) { exit; }

$tla_title       = 'Office Hours with Julie Weix — The Loan Atlas';
$tla_description = 'Join Julie Weix\'s live office hours inside The Loan Atlas — bring the patterns underneath your production and get real-time coaching on mindset, time and personal leadership.';
$tla_active      = '';
?>
  <style>
    ...
    .oh-stats--1 { grid-template-columns: 1fr; }
    .oh-stat {
      background: var(--surface-container-lowest);
      border: 1px solid var(--outline-variant);
    ...
    /* Julie's faculty video — 16:9 embed */
    .oh-video {
    ...
    /* ================================================================
       ...
       opened by either "Join Julie's Office Hours" CTA.
       ================================================================ */
    .ev-modal {
        ...
        <div class="oh-grid">
          ...
          <div class="oh-main">
            ...
            <div class="oh-header" data-reveal="up">
              <div class="oh-thumb">
                <img src="<?php echo TLA_BASE; ?>/assets/live-events/Office-Hours-Julie-Weix.png" alt="Office Hours with Julie Weix" loading="eager" />
              </div>
              ...
              <h1 class="oh-title">Office Hours with Julie Weix</h1>
              </div>
            </div>
            ...
            <!-- Julie's faculty video -->
            <section data-reveal="up">
              <div class="oh-video">
                <iframe src="https://www.youtube-nocookie.com/embed/Cu04tdoY1HM"
                  title="Julie Weix — Faculty introduction"
            ...
            <!-- About Julie -->
            <section data-reveal="up">
              <h2 class="oh-h2">About Julie Weix</h2>
              <div class="oh-about">
                <div class="oh-about__photo">
                  <img src="<?php echo TLA_BASE; ?>/assets/julie-weix-headshot.png" alt="Julie Weix" loading="lazy" />
                </div>
                <div class="oh-about__body">
                  <p>Julie coaches more than 60 of the nation&rsquo;s top-producing originators one-on-one. Her work focuses on the patterns underneath production — how the highest performers protect their time, manage their energy, and lead themselves before they lead anyone else.</p>
                  <p>As an Executive Coach with Performance Experts, her specialty is the mindset and the calendar — personal leadership, time and task management, and the inner work that separates originators who hit one strong year from originators who compound year over year.</p>
                </div>
              </div>
            </section>
            ...
            <!-- Specialties -->
            <section data-reveal="up">
              <h2 class="oh-h2">Julie's Specialties</h2>
              <div class="oh-chips">
                <span class="oh-chip">Leadership</span>
                <span class="oh-chip">Personal Development</span>
                <span class="oh-chip">Mindset</span>
                <span class="oh-chip">Time &amp; Task Management</span>
                <span class="oh-chip">Executive Coaching</span>
              </div>
            </section>

            <!-- Experience — Julie is an executive coach, not an originator, so there is
                 no production figure (productionHide in the faculty data). -->
            <section data-reveal="up">
              <h2 class="oh-h2">Julie's Experience</h2>
              <div class="oh-stats oh-stats--2">
                <div class="oh-stat">
                  <div class="oh-stat__num" data-countup="15" data-countup-suffix="+">15+</div>
                  <div class="oh-stat__label">Years of high-level corporate experience</div>
                </div>
                <div class="oh-stat">
                  <div class="oh-stat__num" data-countup="60" data-countup-suffix="+">60+</div>
                  <div class="oh-stat__label">Top-producing originators coached one-on-one</div>
                </div>
              </div>
            </section>
            ...
            <div class="oh-cta-foot" data-reveal="up">
              <button type="button" class="tlc-btn oh-join-btn" data-ev-modal>Join Julie's Office Hours</button>
            </div>
          ...
          <aside class="oh-side" data-reveal="up">
            ...
            <div class="oh-side__head">
              <h2 class="oh-side__title">Want to Be Coached By Julie?</h2>
            ...
            <div class="tlc-split">
              ...
              <div class="tlc-split__body" style="padding-bottom:0;">
                ...
                <iframe src="https://api.leadconnectorhq.com/widget/booking/5MfGSBd2cfTjpKzdFXGi"
                  ...
                  id="oh-booking-weix" data-embed-id="oh-booking-weix" title="Schedule Booking"></iframe>
              </div>
            </div>
      ...
      <div class="ev-modal__head">
        ...
        <div class="ev-modal__strip" aria-hidden="true">
          <div class="ev-modal__strip-row">
            ...
            <img src="<?php echo TLA_BASE; ?>/assets/live-events/Office-Hours-Julie-Weix-Square.png" alt="" loading="lazy" />
