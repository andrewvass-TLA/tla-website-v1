<?php
/**
 * Body partial for /apm-symposium-2026/ (TLA Full HTML template).
 * Generated from public/custom-sales-pages/apm-symposium-2026.html by scripts/convert-pages.sh — do not hand-edit;
 * edit the source HTML (or the shared header/footer partials) and re-run.
 */
if ( ! defined( 'ABSPATH' ) ) { exit; }

$tla_title       = 'APM Preferred Account — Exclusive Loan Atlas Pricing';
$tla_description = 'APM Preferred Account pricing: full access to The Loan Atlas at $99/mo — down from $349/mo — a $3,000 annual savings, exclusively for APM originators.';
$tla_active      = '';
?>
  <style>
    ...
    /* ── Embedded APM enrollment form (nested inside the pricing card) ──────── */
    .apm-form {
      position: relative;
      z-index: 1;
      margin-top: var(--space-lg);
    ...
    /* The LeadConnector embed script sizes the iframe to the form's own content
       height (~616px per the embed); keep a floor so there's no big empty gap
    ...
    /* With the pill, the savings line is upright and needs normal flow spacing
       (APM's base .mm-plan__save pulls itself up under a big hero title).
    ...
    /* Account-tier heading — unused: the "APM Preferred Account" heading was
    ...
    /* ══════════════════════════════════════════════════════════════════════════
       APM EXCLUSIVE PRICING — two-tier monthly/annual card.
       Ported from public/custom-sales-pages/namb-conference-2026.html so both pricing
       sections on this page present the identical APM member offer.
...
<?php include get_stylesheet_directory() . '/tla/partials/header-minimal.php'; ?>
  ...
  <!-- ── Sticky offer bar ───────────────────────────────────────────────────── -->
  <div class="apm-bar">
    <a class="apm-bar__link" href="#apm-form" aria-label="Activate Your APM Preferred Account — $99/mo, save $3,000 a year">
      <div class="apm-bar__strip">
        <div class="apm-bar__strip-in">
          <span class="apm-bar__label">Activate Your APM Preferred Account</span>
        </div>
      </div>
  ...
  <main>
      ...
      <div class="container">
        <div class="lp-intro__content">
          ...
          <div class="lp-intro__actions" data-hero-step="4">
            <a class="btn btn--gold btn--lg" href="#apm-form">Activate Your APM Preferred Account</a>
          </div>
        </div>
      </div>
    ...
    <section class="mm-offer" aria-labelledby="mm-offer-heading">
      <div class="container">
        <div id="apm-form" class="mm-offer__card" data-reveal="scale">
          <div class="mm-plan__lockup" aria-label="The Loan Atlas — APM Preferred Account pricing">
          ...
          <div class="apm-form">
            <div class="apm-form__head">
              <h4 class="apm-form__title">Activate Your APM Preferred Account</h4>
              <p class="apm-form__sub">Complete the form below and our team will get you set up at $99/mo.</p>
            </div>
            <div class="apm-form__embed">
              <iframe
                src="https://api.leadconnectorhq.com/widget/form/WxgaoLJFq4q1WM1HJbkK"
                style="width:100%;height:100%;border:none;border-radius:3px"
                id="inline-WxgaoLJFq4q1WM1HJbkK-top"
                ...
                data-form-name="CA: APM"
                data-height="616"
                data-layout-iframe-id="inline-WxgaoLJFq4q1WM1HJbkK-top"
                data-form-id="WxgaoLJFq4q1WM1HJbkK"
        ...
        <div class="lp-bridge__stack">
          ...
          <div class="lp-bridge__inner" data-reveal="up">
            ...
            <p class="text-brass" style="font-family: var(--font-display); font-size: clamp(1.5rem, 1.1rem + 1.4vw, 2.125rem); font-weight: 800; line-height: 1.35; letter-spacing: -0.015em; margin: 0;">
              With your APM Preferred Account, you can install them all for less than the commission of one extra loan.
            </p>
          </div>
    ...
    <!-- NOTE: the Platinum Marketing section (was 7b) is intentionally removed —
         the APM Preferred Account is $99/mo flat with no free-months bonus, so
    ...
    <!-- ── 12. APM PRICING ──────────────────────────────────────────────────── -->
    <section class="mm-pricing" id="pricing" aria-label="APM Preferred Account pricing">
      <div class="container">
          ...
          <div class="apm-form">
            ...
            <div class="apm-form__embed">
              <iframe
                src="https://api.leadconnectorhq.com/widget/form/WxgaoLJFq4q1WM1HJbkK"
                style="width:100%;height:100%;border:none;border-radius:3px"
                id="inline-WxgaoLJFq4q1WM1HJbkK"
                data-layout="{'id':'INLINE'}"
                data-trigger-type="alwaysShow"
                data-trigger-value=""
                data-activation-type="alwaysActivated"
                ...
                data-form-name="CA: APM"
                data-height="616"
                data-layout-iframe-id="inline-WxgaoLJFq4q1WM1HJbkK"
                data-form-id="WxgaoLJFq4q1WM1HJbkK"
                data-cookie-consent="true"
                data-cookie-consent-provider="auto"
                title="CA: APM">
...
<?php include get_stylesheet_directory() . '/tla/partials/footer.php'; ?>
  ...
  <!-- LeadConnector form embed (APM enrollment form) -->
