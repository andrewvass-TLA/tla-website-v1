<?php
/**
 * Body partial for /office-hours-josh-mettle/ (TLA Full HTML template).
 * Generated from public/office-hours-josh-mettle.html by scripts/convert-pages.sh — do not hand-edit;
 * edit the source HTML (or the shared header/footer partials) and re-run.
 */
if ( ! defined( 'ABSPATH' ) ) { exit; }

$tla_title       = 'Office Hours with Josh Mettle — The Loan Atlas';
$tla_description = 'Join Josh Mettle\'s live office hours inside The Loan Atlas — bring your live deals and get real-time answers from a top-producing coach.';
$tla_active      = '';
?>
  <style>
    ...
    /* Josh's faculty video — 16:9 embed */
    .oh-video {
    ...
    /* ================================================================
       ...
       opened by either "Join Josh's Office Hours" CTA.
       ================================================================ */
    .ev-modal {
        ...
        <div class="oh-grid">
          ...
          <div class="oh-main">
            ...
            <div class="oh-header" data-reveal="up">
              <div class="oh-thumb">
                <img src="<?php echo TLA_BASE; ?>/assets/live-events/Office-Hours-Josh-Mettle-0923-16x9.png" alt="Office Hours with Josh Mettle" loading="eager" />
              </div>
              ...
              <h1 class="oh-title">Office Hours with Josh Mettle</h1>
              </div>
            </div>
            ...
            <!-- Josh's faculty video -->
            <section data-reveal="up">
              <div class="oh-video">
                <iframe src="https://www.youtube-nocookie.com/embed/NVz6KMeSf9k"
                  title="Josh Mettle — Faculty introduction"
            ...
            <!-- About Josh -->
            <section data-reveal="up">
              <h2 class="oh-h2">About Josh Mettle</h2>
              <div class="oh-about">
                ...
                <div class="oh-about__body">
                  <p>Josh is one of the most successful originator-leaders in the country — a top 1% producer who has scaled into division leadership while continuing to publish, podcast, and build a public-facing brand that produces real loan volume. Over 25 years in the mortgage industry with $1.17B in personal production, and named to the top 1% of mortgage originators in 2020 by <em>Mortgage Executive Magazine</em>.</p>
                  <p>He currently leads a $250M production team and co-owns a nine-figure real estate portfolio. His specialty is marketing that compounds — content, audience-building and consumer-direct strategy — and he drives the faculty’s work on health, energy and financial freedom.</p>
                </div>
              </div>
            </section>
            ...
            <!-- Specialties -->
            <section data-reveal="up">
              <h2 class="oh-h2">Josh's Specialties</h2>
              <div class="oh-chips">
                <span class="oh-chip">Marketing That Compounds</span>
                <span class="oh-chip">Content &amp; Audience-Building</span>
                <span class="oh-chip">Consumer-Direct Strategy</span>
                <span class="oh-chip">Team &amp; Division Leadership</span>
                <span class="oh-chip">Health, Energy &amp; Financial Freedom</span>
              </div>
            </section>

            <!-- 2025 Production -->
            <section data-reveal="up">
              <h2 class="oh-h2">Josh's 2025 Production</h2>
              <div class="oh-stats oh-stats--2">
                <div class="oh-stat">
                  <div class="oh-stat__num" data-countup="190.8" data-countup-prefix="$" data-countup-suffix="M">$190.8M</div>
                  <div class="oh-stat__label">Total funded volume</div>
                </div>
                <div class="oh-stat">
                  <div class="oh-stat__num" data-countup="358" data-countup-suffix="">358</div>
            ...
            <div class="oh-cta-foot" data-reveal="up">
              <button type="button" class="tlc-btn oh-join-btn" data-ev-modal>Join Josh's Office Hours</button>
            </div>
          ...
          <aside class="oh-side" data-reveal="up">
            ...
            <div class="oh-side__head">
              <h2 class="oh-side__title">Want to Be Coached By Josh?</h2>
            ...
            <div class="tlc-split">
              ...
              <div class="tlc-split__body" style="padding-bottom:0;">
                ...
                <iframe src="https://api.leadconnectorhq.com/widget/booking/5MfGSBd2cfTjpKzdFXGi"
                  ...
                  id="oh-booking-mettle" data-embed-id="oh-booking-mettle" title="Schedule Booking"></iframe>
              </div>
            </div>
      ...
      <div class="ev-modal__head">
        ...
        <div class="ev-modal__strip" aria-hidden="true">
          <div class="ev-modal__strip-row">
            ...
            <img src="<?php echo TLA_BASE; ?>/assets/live-events/Office-Hours-Josh-Mettle-Square.png" alt="" loading="lazy" />
