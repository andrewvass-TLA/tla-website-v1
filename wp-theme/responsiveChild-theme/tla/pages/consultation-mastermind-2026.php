<?php
/**
 * Body partial for /consultation-mastermind-2026/ (TLA Full HTML template).
      ...
      <div class="container">
        <div class="hero-booking">
          ...
          <div class="hero-v2__intro">
            ...
            <p class="t-body-lg" data-hero-step="3">You can't fix what you can't see. This free 1-hour business assessment will show you exactly where your next level of production is hiding — and how to get to it.</p>
