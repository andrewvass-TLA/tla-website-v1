<?php
/**
 * Body partial for /namb-conference-2026/ (TLA Full HTML template).
 * Generated from public/custom-sales-pages/namb-conference-2026.html by scripts/convert-pages.sh — do not hand-edit;
 * edit the source HTML (or the shared header/footer partials) and re-run.
 */
if ( ! defined( 'ABSPATH' ) ) { exit; }

$tla_title       = 'NAMB Platinum Super Bonus — Exclusive Loan Atlas Pricing';
$tla_description = 'NAMB member pricing: full access to The Loan Atlas at $149/mo — down from $349/mo — locked in, plus 3 months free of Platinum Marketing.';
$tla_active      = '';
?>
  <style>
    ...
    .namb-bar__link:hover {
      filter: brightness(1.06);
    }
    .namb-bar__link:focus-visible {
      outline: 3px solid #ffd56c;
      outline-offset: -3px;
    }
    @media (prefers-reduced-motion: reduce) {
      .namb-bar__link { transition: none; }
    }
    ...
    .namb-bar__strip-in::before,
    .namb-bar__strip-in::after {
      content: "";
      height: 1px;
    ...
    /* Tier 2 — dark detail row.
       ...
       - .namb-bar__row-in centres its children, so the text group and the CTA
         share one vertical centre line.
       - .namb-bar__copy inside it is baseline-aligned, so the price, offer and
    ...
    .namb-bar__free b { color: #eac25a; font-weight: 800; }
    .namb-bar__save {
      font-family: var(--font-display);
      font-weight: 800;
      font-size: 1.3125rem;
    ...
    @media (max-width: 1279px) {
      .namb-bar__label { font-size: 0.875rem; letter-spacing: 0.15em; }
      .namb-bar__row-in { padding: 15px var(--gutter); }
      .namb-bar__price { font-size: 1.625rem; }
      .namb-bar__free, .namb-bar__save { font-size: 1.125rem; }
      .namb-bar__plus { font-size: 1.3125rem; }
    }
    @media (max-width: 1099px) {
      .namb-bar__label { font-size: 0.8125rem; letter-spacing: 0.14em; }
      .namb-bar__price { font-size: 1.375rem; }
      .namb-bar__free, .namb-bar__save { font-size: 1rem; }
      .namb-bar__plus { font-size: 1.1875rem; }
    }
    @media (max-width: 899px) {
      .namb-bar__strip-in { padding: 6px var(--gutter); }
      .namb-bar__label { font-size: 0.75rem; letter-spacing: 0.12em; }
      .namb-bar__row-in { padding: 13px var(--gutter); }
      .namb-bar__price { font-size: 1.1875rem; }
      .namb-bar__free, .namb-bar__save { font-size: 0.875rem; }
      .namb-bar__plus { font-size: 1rem; }
    }
    ...
    @media (max-width: 639px) {
      .namb-bar__label { font-size: 0.625rem; letter-spacing: 0.06em; }
      .namb-bar__strip-in::before,
      .namb-bar__strip-in::after { width: clamp(12px, 4vw, 40px); }
      .namb-bar__row-in { padding: 9px 14px; gap: 8px 12px; }
      .namb-bar__copy { gap: 4px 12px; }
      .namb-bar__price { font-size: 1.25rem; }
      .namb-bar__price s { display: none; }
      .namb-bar__plus { display: none; }
      .namb-bar__free {
        flex-basis: 100%;
        text-align: center;
        font-size: 0.8125rem;
      ...
      .namb-bar__free::before {
        content: "+ ";
        color: rgba(234, 194, 90, 0.85);
        font-weight: 700;
      }
      .namb-bar__save { font-size: 0.8125rem; margin-left: 0; }
    }
    /* Narrowest phones: the label is wider than the strip at full tracking. */
    @media (max-width: 380px) {
      .namb-bar__label { font-size: 0.625rem; letter-spacing: 0.06em; }
      .namb-bar__strip-in { gap: 8px; }
      .namb-bar__strip-in::before,
      .namb-bar__strip-in::after { display: none; }
    }
    ...
    /* ══════════════════════════════════════════════════════════════════════════
       ...
       Ported from public/custom-sales-pages/vmba-convention-2026.html so both pricing
...
<?php include get_stylesheet_directory() . '/tla/partials/header-minimal.php'; ?>
  ...
  <!-- ── Sticky offer bar ───────────────────────────────────────────────────── -->
  <div class="namb-bar">
    <a class="namb-bar__link" href="https://members.theloanatlas.com/checkouts/premium-membership-checkout-namb-2026/" aria-label="Activate Your NAMB Platinum Super Bonus — $149/mo plus 3 months free Platinum Marketing, save $2,900">
      <div class="namb-bar__strip">
        <div class="namb-bar__strip-in">
          <span class="namb-bar__label">Activate Your NAMB Platinum Super Bonus</span>
        </div>
      </div>
      <div class="namb-bar__row">
        <div class="namb-bar__row-in">
          <div class="namb-bar__copy">
            <span class="namb-bar__price"><s>$349/mo</s>$149<i>/mo</i></span>
            <span class="namb-bar__plus" aria-hidden="true">+</span>
            <span class="namb-bar__free"><b>3 Months FREE</b> Platinum Marketing</span>
            <span class="namb-bar__save">Save $2,900</span>
          </div>
        </div>
      </div>
    </a>
      ...
      <div class="container">
        <div class="lp-intro__content">
          ...
          <div class="lp-intro__actions" data-hero-step="4">
            <a class="btn btn--gold btn--lg" href="https://members.theloanatlas.com/checkouts/premium-membership-checkout-namb-2026/">Activate Your NAMB Platinum Super Bonus</a>
          </div>
        </div>
      </div>
    ...
    <section class="mm-offer" aria-labelledby="mm-offer-heading">
      <div class="container">
        <div id="namb-form" class="mm-offer__card" data-reveal="scale">
          <div class="mm-plan__lockup" aria-label="The Loan Atlas — NAMB Platinum Super Bonus pricing">
            <img class="mm-plan__lockup-atlas" src="<?php echo TLA_BASE; ?>/assets/Loan Atlas logo-gold.png" alt="The Loan Atlas" />
            <h3 class="mm-plan__lockup-label">NAMB Platinum Super Bonus</h3>
          </div>
          <p class="mm-plan__save"><em>$2,900</em> in Annual Savings — Exclusively for NAMB Members</p>
          <div id="mm-offer-heading" class="mm-offer__steps" style="grid-template-columns: 1fr; max-width: 22rem;">
            <div class="mm-step mm-step--rest">
              ...
              <span class="mm-step__price" style="background: linear-gradient(135deg, #c9961c 0%, #eac25a 50%, #ffd56c 100%); -webkit-background-clip: text; background-clip: text; color: transparent;">$149<span style="font-size: 0.32em; font-weight: 700; letter-spacing: 0;">/mo</span></span>
            </div>
          </div>
          ...
          <p class="mm-offer__fine">12-month commitment. Offer exclusively for NAMB members. Available to new members only.</p>
        </div>
      </div>
    </section>
        ...
        <div class="lp-bridge__stack">
          ...
          <div class="lp-bridge__inner" data-reveal="up">
            ...
            <p class="text-brass" style="font-family: var(--font-display); font-size: clamp(1.5rem, 1.1rem + 1.4vw, 2.125rem); font-weight: 800; line-height: 1.35; letter-spacing: -0.015em; margin: 0;">
              With your NAMB Platinum Super Bonus, you can install them all for less than the commission of one extra loan.
            </p>
          </div>
    ...
    <section class="mm-pricing" id="pricing" aria-labelledby="pricing-heading">
      <div class="container">
        <div class="center" data-reveal="up" style="max-width: 46rem; margin-inline: auto;">
          ...
          <p class="t-body-lg" style="color: rgba(255, 255, 255, 0.68); font-size: clamp(1.125rem, 0.95rem + 0.6vw, 1.375rem);">Full access to everything above — the AI systems, live coaching, and community — at a price reserved only for NAMB members.</p>
        </div>
        ...
        <article id="namb-pricing-card" class="mm-plan" data-reveal="scale">
          ...
          <div class="mm-plan__cta">
            <a class="btn btn--gold btn--lg" href="https://members.theloanatlas.com/checkouts/premium-membership-checkout-namb-2026/">
              Activate Your NAMB Platinum Super Bonus
            </a>
          </div>

          <p class="mm-plan__fine">12-month commitment. Offer exclusively for NAMB members. Available to new members only.</p>
        </article>
      </div>
    </section>
