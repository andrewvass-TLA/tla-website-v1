<?php
/**
 * Body partial for /market-update-with-barry-habib/ (TLA Full HTML template).
 * Generated from public/market-update-with-barry-habib.html by scripts/convert-pages.sh — do not hand-edit;
...
$tla_description = 'Tim Braheem and Barry Habib on where rates are actually headed — and where the deals are hiding when they aren’t obvious. The economic picture behind the headlines, the wealth-creation refinance and rent-vs-own presentations, and the call script for reactivating your database.';
$tla_active      = '';
?>
  <style>
    ...
    /* Full-width watch CTA (gold .tlc-btn, stretched) — at the bottom of the card */
    ...
    /* The guest headshots are already square, well-framed crops (500x500) —
       the portrait crop bias above would push their faces down, so center them. */
    .oh-person__photo--square img { object-position: 50% 50%; }
    ...
    .oh-person__role {
      ...
      letter-spacing: 0.14em; text-transform: uppercase; line-height: 1.45;
        ...
        <div class="oh-grid">
          ...
          <div class="oh-main">
            ...
            <div class="oh-header" data-reveal="up">
              <div class="oh-thumb">
                <img src="<?php echo TLA_BASE; ?>/assets/live-events/past-events/Market-Update-Barry-Habib-0820-16x9.jpg" alt="Market Update with Barry Habib — The Loan Atlas" loading="eager" />
              </div>
            ...
            <section data-reveal="up">
              <p class="oh-prose">Rates climbed through the summer, the phone got quieter, and the deals that used to be obvious dried up. If you&rsquo;re waiting for the market to hand you closings again, you&rsquo;re going to be waiting a while&hellip;and watching the originators who know where to look pull ahead.</p>
              <p class="oh-prose">In this special session inside the Loan Atlas, Tim Braheem and Barry Habib give a clear read on where rates are actually headed and, more importantly, where the deals are hiding when they aren&rsquo;t obvious. You&rsquo;ll get the real economic picture behind the headlines, the objection-proof presentations to bring to clients and Realtors, and the daily discipline that separates the originators who grow in this market from the ones waiting it out.</p>
            </section>
            ...
            <section class="oh-band" data-reveal="up">
              ...
              <ul class="oh-list">
                <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg><span>Get Barry Habib&rsquo;s real read on where rates are headed &mdash; the truth behind the oil, Fed, and inflation headlines &mdash; so you can walk into every client and Realtor conversation with a clear, confident point of view instead of guessing</span></li>
                <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg><span>Master the wealth-creation refinance presentation that turns past clients you&rsquo;d written off as &ldquo;locked in&rdquo; at a low rate into closings &mdash; same monthly payment, years shaved off their loan, real equity built for their family</span></li>
                <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg><span>Learn the rent-vs-own reframe that shows a client why 3% appreciation on a home can beat 10% in an investment account, and how to shut down the &ldquo;renting is cheaper&rdquo; objection before it&rsquo;s ever raised</span></li>
                <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg><span>Walk away with the exact call script for reactivating your database &mdash; &ldquo;last time we saved rate, this time we save years and create wealth&rdquo; &mdash; the outreach that turns a handful of morning calls into two-plus extra loans a month</span></li>
                <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg><span>Apply the same wealth-creation conversation to move-up buyers who feel stuck in their current home, opening a second pipeline of deals in a market where they&rsquo;re hard to find</span></li>
                <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg><span>See why your presentation is where every deal is won or lost, and how to build one so airtight it answers every objection before a client can voice it</span></li>
              </ul>
            </section>

            <!-- Pull-quote — shared testimonial block (no gold mark; inline quotes instead) -->
            <figure class="quote-card" data-reveal="up">
              <blockquote class="quote-card__quote">&ldquo;Great originators know where to find deals when it&rsquo;s not so obvious. They know what rocks to turn over to yield rewards.&rdquo;</blockquote>
              <figcaption class="quote-card__attr">
                <div class="quote-card__name">Tim Braheem</div>
              </figcaption>
            </figure>
            ...
            <section data-reveal="up">
              ...
              <div class="oh-people">
                ...
                <div class="oh-person">
                  <div class="oh-person__photo oh-person__photo--square"><img src="<?php echo TLA_BASE; ?>/assets/barry-habib.jpg" alt="Barry Habib" loading="lazy" /></div>
                  <div class="oh-person__body">
                    <p class="oh-person__name">Barry Habib</p>
                    <p class="oh-person__role">Founder &amp; CEO</p>
                    <p class="oh-person__org">MBS Highway</p>
                  </div>
                </div>
              </div>
            </section>
          ...
          <aside class="oh-side" data-reveal="up">
            ...
            <div class="oh-side__head">
              <h2 class="oh-side__title">Get On-Demand Access to Every Live Event</h2>
            ...
            <div class="tlc-navy">
              <div class="tlc-navy__in">
                ...
                <p class="tlc-navy__text">Every live event is included with membership — live and on demand. Here's everything you unlock inside The Loan Atlas:</p>
            ...
            <div class="tlc-split">
              ...
              <div class="tlc-split__body" style="padding-bottom:0;">
                ...
                <iframe src="https://api.leadconnectorhq.com/widget/booking/5MfGSBd2cfTjpKzdFXGi"
                  ...
                  id="oh-booking-habib" data-embed-id="oh-booking-habib" title="Schedule Booking"></iframe>
              </div>
            </div>
      ...
      <div class="ev-modal__head">
        ...
        <div class="ev-modal__strip" aria-hidden="true">
          <div class="ev-modal__strip-row">
            ...
            <img src="<?php echo TLA_BASE; ?>/assets/live-events/past-events/Market-Update-Barry-Habib-0820-1x1.jpg" alt="" loading="lazy" />
