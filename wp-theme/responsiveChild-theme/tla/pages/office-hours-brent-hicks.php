<?php
/**
 * Body partial for /office-hours-brent-hicks/ (TLA Full HTML template).
 * Generated from public/office-hours-brent-hicks.html by scripts/convert-pages.sh — do not hand-edit;
 * edit the source HTML (or the shared header/footer partials) and re-run.
 */
if ( ! defined( 'ABSPATH' ) ) { exit; }

$tla_title       = 'Office Hours with Brent Hicks — The Loan Atlas';
$tla_description = 'Join Brent Hicks\' live office hours inside The Loan Atlas — bring your live deals and get real-time answers from a top-producing coach.';
$tla_active      = '';
?>
  <style>
    ...
    /* Brent's faculty video — 16:9 embed */
    .oh-video {
    ...
    /* ================================================================
       ...
       opened by either "Join Brent's Office Hours" CTA.
       ================================================================ */
    .ev-modal {
        ...
        <div class="oh-grid">
          ...
          <div class="oh-main">
            ...
            <div class="oh-header" data-reveal="up">
              <div class="oh-thumb">
                <img src="<?php echo TLA_BASE; ?>/assets/live-events/Office-Hours-Brent-Hicks.png" alt="Office Hours with Brent Hicks" loading="eager" />
              </div>
              ...
              <h1 class="oh-title">Office Hours with Brent Hicks</h1>
              </div>
            </div>
            ...
            <!-- Brent's faculty video -->
            <section data-reveal="up">
              <div class="oh-video">
                <iframe src="https://www.youtube-nocookie.com/embed/W1u-X5dArWc"
                  title="Brent Hicks — Faculty introduction"
            ...
            <!-- About Brent -->
            <section data-reveal="up">
              <h2 class="oh-h2">About Brent Hicks</h2>
              <div class="oh-about">
                <div class="oh-about__photo">
                  <img src="<?php echo TLA_BASE; ?>/assets/brent-hicks-headshot.png" alt="Brent Hicks" loading="lazy" />
                </div>
                <div class="oh-about__body">
                  <p>Brent has personally originated more than $1.5B in loan volume, earned top-50-nationwide rankings, and now leads a division as one of the country&rsquo;s most respected mortgage executives. His path moved from elite individual production into building and recruiting teams that perform at the same level.</p>
                  <p>As Divisional President at Clear Modern Mortgage, his specialty is leadership, team building and recruiting — done at the highest level, first as an elite producer, then as a leader scaling teams that perform at the same level he did.</p>
                </div>
              </div>
            </section>
            ...
            <!-- Specialties -->
            <section data-reveal="up">
              <h2 class="oh-h2">Brent's Specialties</h2>
              <div class="oh-chips">
                <span class="oh-chip">Leadership</span>
                <span class="oh-chip">Team Building</span>
                <span class="oh-chip">Recruiting</span>
                <span class="oh-chip">Scaling Production Teams</span>
                <span class="oh-chip">Elite Personal Production</span>
              </div>
            </section>

            <!-- Career production — Brent's figure is lifetime, not a 2025 annual number -->
            <section data-reveal="up">
              <h2 class="oh-h2">Brent's Production</h2>
              <div class="oh-stats oh-stats--1">
                <div class="oh-stat">
                  <div class="oh-stat__num" data-countup="1.5" data-countup-prefix="$" data-countup-suffix="B">$1.5B</div>
                  <div class="oh-stat__label">Personal production originated over his career as a loan originator</div>
                </div>
              </div>
            </section>
            ...
            <div class="oh-cta-foot" data-reveal="up">
              <button type="button" class="tlc-btn oh-join-btn" data-ev-modal>Join Brent's Office Hours</button>
            </div>
          ...
          <aside class="oh-side" data-reveal="up">
            ...
            <div class="oh-side__head">
              <h2 class="oh-side__title">Want to Be Coached By Brent?</h2>
            ...
            <div class="tlc-split">
              ...
              <div class="tlc-split__body" style="padding-bottom:0;">
                ...
                <iframe src="https://api.leadconnectorhq.com/widget/booking/5MfGSBd2cfTjpKzdFXGi"
                  ...
                  id="oh-booking-hicks" data-embed-id="oh-booking-hicks" title="Schedule Booking"></iframe>
              </div>
            </div>
      ...
      <div class="ev-modal__head">
        ...
        <div class="ev-modal__strip" aria-hidden="true">
          <div class="ev-modal__strip-row">
            ...
            <img src="<?php echo TLA_BASE; ?>/assets/live-events/Office-Hours-Brent-Hicks-Square.png" alt="" loading="lazy" />
