...
?>
  <style>
    ...
    @media (max-width: 600px) {
      .lp-intro__title {
        font-size: clamp(1.875rem, 1rem + 3.6vw, 2.5rem);
    ...
    @media (max-width: 859.98px) {
      ...
      /* Live Coaching: the 4-image overlap doesn't fit a narrow column — show
         only the first card, laid out normally instead of absolutely. */
      .mm-card-stack {
        aspect-ratio: auto;
        position: static;
      }
      .mm-card-stack__img:nth-child(n + 2) { display: none; }
    ...
    /* ── Hero stage — system card over a scrolling event-image strip ──────────
       Left: cycling system eyebrow + name. Divider. Right: chat bubbles. The
       whole pair cycles through the four systems. Marquee adapts Platinum hero. */
    .hm-stage {
      position: relative;
      max-width: var(--container-max);
    ...
    /* Background — faded scrolling strip of the event images (behind the box) */
    .hm-marquee {
      position: absolute;
      top: 0; bottom: 0;
      left: 50%;
    ...
    .hm-stage:hover .hm-marquee__track { animation-play-state: paused; }
...
<?php include get_stylesheet_directory() . '/tla/partials/header-minimal.php'; ?>
  ...
  <main>
    ...
    <section class="lp-intro" aria-labelledby="mm-hero-heading">
      ...
      <!-- System graphic — a box (system name | divider | chat) over a
           horizontally-scrolling strip of the what's-inside event images.
           The whole pair cycles through the four systems (driven by the script). -->
      <div class="hm-stage" data-hero-step="5" data-hm-stage>

        <!-- Background — scrolling event images (duplicated set for seamless loop) -->
        <div class="hm-marquee" aria-hidden="true">
          <div class="hm-marquee__track">
            <div class="hm-marquee__item"><img src="<?php echo TLA_BASE; ?>/assets/what%27s-inside-masterclass.jpg" alt="" loading="eager" /></div>
            <div class="hm-marquee__item"><img src="<?php echo TLA_BASE; ?>/assets/what%27s-inside-talk-to-tim.jpg" alt="" loading="eager" /></div>
            <div class="hm-marquee__item"><img src="<?php echo TLA_BASE; ?>/assets/what%27s-inside-office-hours.jpg" alt="" loading="eager" /></div>
            <div class="hm-marquee__item"><img src="<?php echo TLA_BASE; ?>/assets/what%27s-inside-ai-labs.jpg" alt="" loading="eager" /></div>
            <!-- duplicate set -->
            <div class="hm-marquee__item"><img src="<?php echo TLA_BASE; ?>/assets/what%27s-inside-masterclass.jpg" alt="" /></div>
            <div class="hm-marquee__item"><img src="<?php echo TLA_BASE; ?>/assets/what%27s-inside-talk-to-tim.jpg" alt="" /></div>
            <div class="hm-marquee__item"><img src="<?php echo TLA_BASE; ?>/assets/what%27s-inside-office-hours.jpg" alt="" /></div>
            <div class="hm-marquee__item"><img src="<?php echo TLA_BASE; ?>/assets/what%27s-inside-ai-labs.jpg" alt="" /></div>
          </div>
        </div>
