...
?>
  <style>
    ...
    .mm-countdown {
      ...
      align-items: center;
      gap: 10px;
      /* Bottom margin gives the timer space before the dashboard graphic below. */
      margin: var(--space-md) auto var(--space-xl);
    }
    /* Label + expires grouped above the clock */
    .mm-countdown__text {
      display: flex;
      flex-direction: column;
      align-items: center;
    ...
    <section class="lp-intro" aria-labelledby="mm-hero-heading">
      <div class="container">
        <div class="lp-intro__content">
          ...
          <div class="mm-countdown" data-hero-step="4" data-countdown="2026-07-12T23:59:59" role="timer" aria-label="Time remaining until the offer ends">
            <div class="mm-countdown__text">
              <span class="mm-countdown__label">Limited Time Offer</span>
              <span class="mm-countdown__expires">Expires Sunday, July&nbsp;12th</span>
            </div>
