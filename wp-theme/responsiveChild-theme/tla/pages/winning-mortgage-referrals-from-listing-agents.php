<?php
/**
 * Body partial for /winning-mortgage-referrals-from-listing-agents/ (TLA Full HTML template).
 * Generated from public/winning-mortgage-referrals-from-listing-agents.html by scripts/convert-pages.sh — do not hand-edit;
          ...
          <div class="oh-main">
            ...
            <section data-reveal="up">
              ...
              <div class="oh-people">
                ...
                <div class="oh-person">
                  <div class="oh-person__photo oh-person__photo--square"><img src="<?php echo TLA_BASE; ?>/assets/Jason-Drobeck.png" alt="Jason Drobeck" loading="lazy" /></div>
                  <div class="oh-person__body">
                    <p class="oh-person__name">Jason Drobeck</p>
                    <p class="oh-person__role">Branch Manager</p>
                    <p class="oh-person__org">NEO Home Loans</p>
                  </div>
                </div>
                <div class="oh-person">
                  <div class="oh-person__photo oh-person__photo--square"><img src="<?php echo TLA_BASE; ?>/assets/Skyler-Ford.png" alt="Skyler Ford" loading="lazy" /></div>
                  <div class="oh-person__body">
                    <p class="oh-person__name">Skyler Ford</p>
                    <p class="oh-person__role">Mortgage Advisor</p>
                    <p class="oh-person__org">NEO Home Loans</p>
                  </div>
                </div>
              </div>
            ...
            <div class="tlc-split">
              ...
              <div class="tlc-split__body" style="padding-bottom:0;">
                ...
                <iframe src="https://api.leadconnectorhq.com/widget/booking/5MfGSBd2cfTjpKzdFXGi"
                  ...
                  id="oh-booking-listing-agents" data-embed-id="oh-booking-listing-agents" title="Schedule Booking"></iframe>
              </div>
            </div>
      ...
      <div class="ev-modal__head">
        ...
        <div class="ev-modal__strip" aria-hidden="true">
          <div class="ev-modal__strip-row">
            ...
            <img src="<?php echo TLA_BASE; ?>/assets/live-events/MBS-Highway-September-2026-500x500.png" alt="" loading="lazy" />
