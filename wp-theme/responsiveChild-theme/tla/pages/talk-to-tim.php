...
?>
  <style>
    ...
    .oh-main > .oh-header + section {
      /* title overflows 5.6px below; the next section opens on a display h2
         whose tight line-height pulls its cap-height up ~9px */
      margin-top: calc(var(--oh-title-gap) - 3.4px);
    }
        ...
        <div class="oh-grid">
          ...
          <div class="oh-main">
            ...
            <div class="oh-header" data-reveal="up">
              <div class="oh-thumb">
                <img src="<?php echo TLA_BASE; ?>/assets/live-events/Talk-to-Tim.png" alt="Talk to Tim" loading="eager" />
              </div>
            ...
            <div class="tlc-split">
              ...
              <div class="tlc-split__body" style="padding-bottom:0;">
                ...
                <iframe src="https://api.leadconnectorhq.com/widget/booking/5MfGSBd2cfTjpKzdFXGi"
                  ...
                  id="oh-booking-tim" data-embed-id="oh-booking-tim" title="Schedule Booking"></iframe>
              </div>
            </div>
