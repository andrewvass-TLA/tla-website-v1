...
?>
  <style>
    ...
    @media (max-width: 560px) {
      ...
      /* Hide the phone image on mobile; coaches stack into a single column. */
      .aicg__center { display: none; }
    }
    ...
    /* On mobile, drop the pill container and turn each tab into a
       distinct, clearly-tappable outlined button on its own row. */
    @media (max-width: 560px) {
      .frs-tabs__bar {
        flex-wrap: wrap;
        gap: 8px;
      ...
      .frs-tab {
        ...
        border-radius: var(--radius-xl);
        padding: 12px 16px;
        box-shadow: 0 1px 2px rgba(2, 28, 54, 0.06);
      }
      .frs-tab.is-active {
        border-color: var(--primary);
        box-shadow: 0 2px 8px rgba(2, 28, 54, 0.18);
      }
    }
    .frs-tab {
      flex: 0 0 auto;
