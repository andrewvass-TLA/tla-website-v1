<?php
/**
 * Body partial for /ai-lab-success-with-follow-up-pro/ (TLA Full HTML template).
 * Generated from public/ai-lab-success-with-follow-up-pro.html by scripts/convert-pages.sh — do not hand-edit;
 * edit the source HTML (or the shared header/footer partials) and re-run.
 */
if ( ! defined( 'ABSPATH' ) ) { exit; }

$tla_title       = 'AI Lab: Success With Follow Up Pro — The Loan Atlas';
$tla_description = 'Join a live Follow-Up Pro Show &amp; Tell inside The Loan Atlas — two members share how they\'ve made Follow-Up Pro part of their daily workflow to stay consistent and create a better experience for borrowers and referral partners.';
$tla_active      = '';
?>
  <style>
        ...
        <div class="oh-grid">
          ...
          <div class="oh-main">
            ...
            <div class="oh-header" data-reveal="up">
              <div class="oh-thumb">
                <img src="<?php echo TLA_BASE; ?>/assets/live-events/AI-Lab-Success-With-Follow-Up-Pro-0813-16x9.jpg" alt="AI Lab: Success With Follow Up Pro — The Loan Atlas" loading="eager" />
              </div>
              <div class="oh-meta">
              ...
              <h1 class="oh-title">AI Lab: Success With Follow Up Pro</h1>
            </div>

            <!-- About this AI Lab -->
            <section data-reveal="up">
              <p class="oh-prose">You&rsquo;re already having great conversations with borrowers. The question is&hellip;what happens after the call?</p>
              <p class="oh-prose">If you&rsquo;re still piecing together notes, trying to remember key details, updating your CRM manually, and writing follow-up emails from scratch, you&rsquo;re spending valuable time on work that doesn&rsquo;t have to be manual.</p>
              <p class="oh-prose">Join us for a live Follow-Up Pro Show &amp; Tell, where two Loan Atlas members will walk you through exactly how they&rsquo;ve made Follow-Up Pro part of their daily workflow.</p>
            </section>

            <!-- What you'll learn -->
            <section data-reveal="up">
              <h2 class="oh-h2">What You&rsquo;ll Learn</h2>
              <p class="oh-prose">How to use transcripts, voice memo recaps, and rough notes to quickly generate:</p>
              <ul class="oh-list">
                <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg><span>Organized borrower details and next steps</span></li>
                <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg><span>Flags of potential challenges to address early</span></li>
                <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg><span>CRM-ready conversation summaries to get your team on the same page</span></li>
                <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg><span>Personalized borrower follow-up messages</span></li>
                <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg><span>Referral partner updates when appropriate</span></li>
              </ul>
              <p class="oh-prose">Real members showing how they use Follow-Up Pro to reduce administrative work, stay consistent, and create a better experience for borrowers and referral partners.</p>
              <p class="oh-prose">By the end of this session, you&rsquo;ll know exactly how to start using Follow-Up Pro after your very next client conversation.</p>
            </section>
            ...
            <div class="oh-cta-foot" data-reveal="up">
              <button type="button" class="tlc-btn oh-watch-btn" data-ev-modal>Join This AI Lab</button>
            </div>
          ...
          <aside class="oh-side" data-reveal="up">
            ...
            <div class="oh-side__head">
              <h2 class="oh-side__title">Want to Join This AI Lab?</h2>
            ...
            <div class="tlc-navy">
              <div class="tlc-navy__in">
                ...
                <p class="tlc-navy__text">Every AI Lab is included with membership — live and on demand. Here's everything you unlock inside The Loan Atlas:</p>
            ...
            <div class="tlc-split">
              ...
              <div class="tlc-split__body" style="padding-bottom:0;">
                ...
                <iframe src="https://api.leadconnectorhq.com/widget/booking/5MfGSBd2cfTjpKzdFXGi"
                  ...
                  id="oh-booking-ai-lab-follow-up-pro" data-embed-id="oh-booking-ai-lab-follow-up-pro" title="Schedule Booking"></iframe>
              </div>
            </div>
