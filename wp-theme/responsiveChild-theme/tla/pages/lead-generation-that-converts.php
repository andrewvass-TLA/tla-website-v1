<?php
/**
 * Body partial for /lead-generation-that-converts/ (TLA Full HTML template).
 * Generated from public/lead-generation-that-converts.html by scripts/convert-pages.sh — do not hand-edit;
 * edit the source HTML (or the shared header/footer partials) and re-run.
 */
if ( ! defined( 'ABSPATH' ) ) { exit; }

$tla_title       = 'Lead Generation That Converts — Masterclass — The Loan Atlas';
$tla_description = 'Join Lead Generation That Converts — Tim Braheem interviews Michael Regan and Jay Voorhees on what\'s actually working right now to generate leads, build trust and create consistent conversations without constant social posting or complicated digital marketing.';
$tla_active      = '';
?>
  <style>
        ...
        <div class="oh-grid">
          ...
          <div class="oh-main">
            ...
            <section data-reveal="up">
              ...
              <ul class="oh-list">
                <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg><span>Why frequent social media posting may not be the best use of your time, even if it builds visibility</span></li>
                <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg><span>How phone calls, personal follow-up, and face-to-face relationships are outperforming many digital touches</span></li>
                <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg><span>How to use AI-assisted content, weekly videos, blogs, and Google Business optimization without losing your personal voice</span></li>
                <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg><span>Where loan officers should focus their marketing energy when they do not have the budget, team, or technical resources to compete in advanced SEO and digital marketing</span></li>
              </ul>
              <p class="oh-prose">You do not need more marketing chaos; you need clearer decisions, better leverage, and a practical system for staying in front of the right people consistently.</p>
            </section>
            ...
            <section data-reveal="up">
              ...
              <div class="oh-people">
                ...
                <div class="oh-person">
                  <div class="oh-person__photo oh-person__photo--square"><img src="<?php echo TLA_BASE; ?>/assets/michael-regan-headshot.png" alt="Michael Regan" loading="lazy" /></div>
                  <div class="oh-person__body">
                    <p class="oh-person__name">Michael Regan</p>
                    <p class="oh-person__role">Mortgage Loan Officer, CMPS&reg;</p>
                    <p class="oh-person__org">Kind Lending</p>
                  </div>
                </div>
                <div class="oh-person">
                  <div class="oh-person__photo oh-person__photo--square"><img src="<?php echo TLA_BASE; ?>/assets/jay-voorhees-headshot.png" alt="Jay Voorhees" loading="lazy" /></div>
                  <div class="oh-person__body">
                    <p class="oh-person__name">Jay Voorhees</p>
                    <p class="oh-person__role">Founder</p>
                    <p class="oh-person__org">JVM Lending</p>
                  </div>
                </div>
              </div>
            </section>
            ...
            <div class="tlc-split">
              ...
              <div class="tlc-split__body" style="padding-bottom:0;">
                ...
                <iframe src="https://api.leadconnectorhq.com/widget/booking/5MfGSBd2cfTjpKzdFXGi"
                  ...
                  id="oh-booking-lead-gen" data-embed-id="oh-booking-lead-gen" title="Schedule Booking"></iframe>
              </div>
            </div>
