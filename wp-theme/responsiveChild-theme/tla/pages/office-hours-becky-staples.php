<?php
/**
 * Body partial for /office-hours-becky-staples/ (TLA Full HTML template).
 * Generated from public/office-hours-becky-staples.html by scripts/convert-pages.sh — do not hand-edit;
 * edit the source HTML (or the shared header/footer partials) and re-run.
 */
if ( ! defined( 'ABSPATH' ) ) { exit; }

$tla_title       = 'Office Hours with Becky Staples — The Loan Atlas';
$tla_description = 'Join Becky Staples\'s live office hours inside The Loan Atlas — bring your live deals and get real-time answers from a top-producing coach.';
$tla_active      = '';
?>
  <style>
    ...
    /* Becky's faculty video — 16:9 embed */
    .oh-video {
    ...
    /* ================================================================
       ...
       opened by either "Join Becky's Office Hours" CTA.
       ================================================================ */
    .ev-modal {
        ...
        <div class="oh-grid">
          ...
          <div class="oh-main">
            ...
            <div class="oh-header" data-reveal="up">
              <div class="oh-thumb">
                <img src="<?php echo TLA_BASE; ?>/assets/live-events/Office-Hours-Becky-Staples-0819-16x9.jpg" alt="Office Hours with Becky Staples" loading="eager" />
              </div>
              ...
              <h1 class="oh-title">Office Hours with Becky Staples</h1>
              </div>
            </div>
            ...
            <!-- Becky's faculty video -->
            <section data-reveal="up">
              <div class="oh-video">
                <iframe src="https://www.youtube-nocookie.com/embed/LN317MG-V4s"
                  title="Becky Staples — Faculty introduction"
            ...
            <!-- About Becky -->
            <section data-reveal="up">
              <h2 class="oh-h2">About Becky Staples</h2>
              <div class="oh-about">
                <div class="oh-about__photo">
                  <img src="<?php echo TLA_BASE; ?>/assets/becky-staples-headshot.png" alt="Becky Staples" loading="lazy" />
                </div>
                <div class="oh-about__body">
                  <p>Becky has spent nearly 20 years in the industry, funded $1B+ in career loan volume, and helped more than 3,600 families. She is ranked as a top-100 U.S. loan officer by volume.</p>
                  <p>Her specialty is the fundamentals — done at the highest level. Production systems and process control, developing new loan officers from the ground up, and delivering the kind of high-touch client experience that produces a billion dollars in volume one client at a time.</p>
                </div>
              </div>
            </section>
            ...
            <!-- Specialties -->
            <section data-reveal="up">
              <h2 class="oh-h2">Becky's Specialties</h2>
              <div class="oh-chips">
                <span class="oh-chip">Production Systems</span>
                <span class="oh-chip">Process Control</span>
                <span class="oh-chip">Developing New Loan Officers</span>
                <span class="oh-chip">High-Touch Client Experience</span>
                <span class="oh-chip">Mastering the Fundamentals</span>
              </div>
            </section>

            <!-- 2025 Production -->
            <section data-reveal="up">
              <h2 class="oh-h2">Becky's 2025 Production</h2>
              <div class="oh-stats oh-stats--2">
                <div class="oh-stat">
                  <div class="oh-stat__num" data-countup="84.3" data-countup-prefix="$" data-countup-suffix="M">$84.3M</div>
                  <div class="oh-stat__label">Total funded volume</div>
                </div>
                <div class="oh-stat">
                  <div class="oh-stat__num" data-countup="201" data-countup-suffix="">201</div>
            ...
            <div class="oh-cta-foot" data-reveal="up">
              <button type="button" class="tlc-btn oh-join-btn" data-ev-modal>Join Becky's Office Hours</button>
            </div>
          ...
          <aside class="oh-side" data-reveal="up">
            ...
            <div class="oh-side__head">
              <h2 class="oh-side__title">Want to Be Coached By Becky?</h2>
            ...
            <div class="tlc-split">
              ...
              <div class="tlc-split__body" style="padding-bottom:0;">
                ...
                <iframe src="https://api.leadconnectorhq.com/widget/booking/5MfGSBd2cfTjpKzdFXGi"
                  ...
                  id="oh-booking-staples" data-embed-id="oh-booking-staples" title="Schedule Booking"></iframe>
              </div>
            </div>
      ...
      <div class="ev-modal__head">
        ...
        <div class="ev-modal__strip" aria-hidden="true">
          <div class="ev-modal__strip-row">
            ...
            <img src="<?php echo TLA_BASE; ?>/assets/live-events/Office-Hours-Beck-Staples-0819.png" alt="" loading="lazy" />
